...
// Default permissions assigned automatically when a user is created or role changes
...
export async function PUT(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    // If role is changing, reset permissions to the new role's defaults
    // (unless permissions are also explicitly provided in the same request)
    ...
    // If permissions are explicitly provided, save them as JSON string
